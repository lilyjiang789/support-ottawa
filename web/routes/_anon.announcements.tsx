...
export default function () {
  ...
  const [{ data: msgBoard, fetching, error }] = useFindMany(api.msgBoard, {
    select: selectObject,
  ...
  const handleAnnouncementTypeSelect = (type: string) => {
    if (isAuthenticated) {
      ...
      navigate(`/sign-in?from=msgBoard&type=${type}`);
    }
  };
    ...
    <div className="flex flex-col h-screen w-full">
        ...
        <main className="flex-1 p-8">
          ...
          <div className="mt-8 pl-[350px]">
            ...
            {!fetching && msgBoard && msgBoard.length === 0 && (
              <div className="text-center py-8">
            ...
            <div className="w-full">
              {msgBoard && msgBoard.map((announcement) => (
